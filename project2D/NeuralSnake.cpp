...
NeuralSnake::NeuralSnake(Grid* pGrid, bool bWrapAround)
{
	m_pGrid = pGrid;
...
void NeuralSnake::Update(float fDeltaTime, Pickup* pPickup)
{
	...
	while (m_fTimeToNextMove <= 0.f)
	{
		...
		// input 0-3: distances in each direction to food
		// input 4-7: distances in each direction to wall
		// UP - RIGHT - DOWN - LEFT
		int nInput[8];
